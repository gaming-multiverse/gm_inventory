return {
	General = {
		...
		inventory = {
			...
			{ name = "sharpening_stone", price = 3.50, count = 999 },
			{ name = "coffee", price = 0.50, count = 999 },
			{ name = "soap", price = 0.30, count = 999 },
			{ name = "water", price = 0.50, count = 999 },
			{ name = "peach", price = 0.50, count = 999 },
			{ name = "kidneybeans_can", price = 2, count = 999 },
			{ name = "thermometer", price = 3, count = 999 },
			{ name = "pocket_watch", price = 6, count = 999 },
			{ name = "cwnotepad", price = 3, count = 999 },
			{ name = "compass", price = 6, count = 999 },
		--	{ name = "map", price = 5, count = 999 },
			{ name = "fan", price = 6, count = 999 },
			{ name = "hairpomade", price = 6, count = 999 },
			{ name = "canteen", price = 15, count = 999 },
			{ name = "self_revive", price = 15, count = 999 },
			{ name = "campfire", price = 5, count = 999 },
			{ name = "p_campfire_coloursmoke01x", price = 100, count = 999 },
			{ name = "cleaningkitgun", price = 20, count = 999 },
			{ name = "cigarette", price = 20, count = 999 }, 
			{ name = "zippo", price = 8, count = 999 }, 
			{ name = "paper_binder", price = 1, count = 999 },
		},
		locations = {
	...
	Sisika = {
		...
		inventory = {
			-- { name = "lumberjack_axe", price = 6.50, count = 50 },
			-- { name = "pickaxe", price = 6.50, count = 50 },
			-- { name = "goldpan", price = 4, count = 50 },
			-- { name = "sharpening_stone", price = 3.50, count = 200 },
			{ name = "coffee", price = 0.50, count = 75 },
			{ name = "soap", price = 0.30, count = 75 },
			{ name = "water", price = 0.50, count = 75 },
			{ name = "peach", price = 0.50, count = 75 },
			{ name = "kidneybeans_can", price = 2, count = 75 },
			{ name = "thermometer", price = 3, count = 75 },
			{ name = "pocket_watch", price = 6, count = 75 },
			{ name = "cwnotepad", price = 3, count = 75 },
			{ name = "compass", price = 6, count = 75 },
			{ name = "map", price = 5, count = 75 },
			{ name = "fan", price = 6, count = 75 },
			{ name = "hairpomade", price = 6, count = 75 },
			{ name = "canteen", price = 15, count = 75 },
			{ name = "self_revive", price = 15, count = 75 },
			{ name = "campfire", price = 5, count = 75 },
			{ name = "cleaningkitgun", price = 20, count = 75 },
			{ name = "cigarette", price = 20, count = 75 },
			{ name = "zippo", price = 10, count = 50 },
		},
		locations = {
	...
	OilPumps = {
		name = "Oil Pumps Seller",
		promptKey = 0xF3830D8E,
		blip = {
			id = "blip_ambient_tithing",
			colour = "BLIP_MODIFIER_MP_COLOR_32",
			scale = 0.2,
		},
		-- groups = {
		-- 	armadillocraftsman = 0,
		-- },
		inventory = {
			{ name = "ricx_oilpump", price = 400, count = 200 },
		},
		locations = {
			vec3(2932.58, 1302.07, 44.48), -- Annesburg
		},
	},
	Ranch = {
		name = "Ranch Store",
    ...
    --     name = 'Pirate Shop',
    --     promptKey = 0xF3830D8E,
    --     promptLabel = "Pirate Shop",
    --     groups = {
	-- 		pirates = 0,
	-- 	},
    --     inventory = {
    --         { name = 'boatticket', price = 0.5, count = 20},
    --     },
	-- 	locations = {
    --         vec(362.67, -1293.45, 44.91),
	-- 	}
    -- },
    ...
    --     name = 'Dynamite Shop',
    --     promptKey = 0xF3830D8E,
    --     promptLabel = "Dynamite Shop",
    --     groups = nil,
    --     inventory = {
    --         { name = 'dynamite', price = 300, count = 1},
    --         { name = 'dynamite', price = 500, count = 1},
    --     },
	-- 	locations = {
    --         vec(1547.36, -7173.38, 63.12),
    --         vec(2781.72, -1128.73, 51.30),
	-- 	}
    -- },
}
